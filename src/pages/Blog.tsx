    ...
    <div className="min-h-screen pt-24 pb-20">
      ...
      <div className="relative mb-12">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center py-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-on-scroll">The LBD Blog</h1>
          ...
          <div className="max-w-md mx-auto animate-on-scroll">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pl-10 rounded-lg bg-white/5 border border-white/10 focus:outline-none focus:ring-2 focus:ring-lbd-accent text-white"
              />
          ...
          <div className="space-y-8">
            <BlurCard className="animate-on-scroll">
              ...
              <div className="space-y-2">
                {categories.map((category) => (
                  <div key={category.name} className="flex justify-between items-center py-2 border-b border-white/10 last:border-0">
            ...
            <BlurCard className="animate-on-scroll">
              ...
              <div className="flex flex-wrap gap-2">
                {["Gaming", "PC Building", "Anime", "Reviews", "Vinyl", "Streaming", "Hardware", "Netflix", "Sony", "RPG", "Manga", "Jazz"].map((tag) => (
                  <Link
                    key={tag}
                    to={`/blog/tag/${tag.toLowerCase()}`}
                    className="text-xs px-3 py-1.5 rounded-full bg-white/5 hover:bg-lbd-accent/20 hover:text-lbd-accent transition-colors flex items-center gap-1"
                  >
            ...
            <BlurCard className="animate-on-scroll">
              ...
              <form className="space-y-3">
                <input
                  ...
                  className="w-full px-4 py-2 rounded-lg bg-white/5 border border-white/10 focus:outline-none focus:ring-2 focus:ring-lbd-accent text-white"
                  required
                />
                <button
                  type="submit"
                  className="w-full px-4 py-2 bg-lbd-accent hover:bg-lbd-accent/90 text-white font-medium rounded-lg transition-colors"
                >
                  Subscribe
                </button>
              </form>
